...
var mod = await __turbopack_context__.y("@prisma/client-2c3a283f134fdcb6");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$column$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/kysely/dist/operation-node/column-node.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$reference$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/kysely/dist/operation-node/reference-node.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$select$2d$query$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/kysely/dist/operation-node/select-query-node.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$table$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/kysely/dist/operation-node/table-node.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/core/dist/db/schema-check.mjs [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$diff$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@better-auth/core/dist/db/schema-diff.mjs [app-rsc] (ecmascript)");
...
function checkSchemaName(schemaName, databaseType) {
    ...
    if (typeof schemaName !== "string" || schemaName.length === 0) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$error$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["BetterAuthError"]("`database.schemaName` must be a non-empty schema name.");
    if (databaseType !== "postgres") throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$error$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["BetterAuthError"](`\`database.schemaName\` is only supported on PostgreSQL, but the configured database type is "${databaseType ?? "unknown"}".`);
}
const createKyselyAdapter = async (config)=>{
    ...
    if ("dialect" in db) {
        const schemaName = db.schemaName;
        checkSchemaName(schemaName, db.type);
        const kysely = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$kysely$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Kysely"]({
            dialect: db.dialect
        });
        return {
    ...
    if ("aggregate" in db && !("createSession" in db)) {
        dialect = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$dialect$2f$sqlite$2f$sqlite$2d$dialect$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SqliteDialect"]({
            database: db
        });
        transaction = true;
    }
    if ("getConnection" in db) {
        dialect = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$dialect$2f$mysql$2f$mysql$2d$dialect$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MysqlDialect"](db);
        transaction = true;
    }
    if ("connect" in db) {
        dialect = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$dialect$2f$postgres$2f$postgres$2d$dialect$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PostgresDialect"]({
            pool: db
        });
        transaction = true;
    }
    if ("fileControl" in db) {
        const { BunSqliteDialect } = await __turbopack_context__.A("[project]/node_modules/@better-auth/kysely-adapter/dist/bun-sqlite-dialect-C7ftEUSI.mjs [app-rsc] (ecmascript, async loader)");
    ...
    if ("batch" in db && "exec" in db && "prepare" in db) {
        const { createD1IndexIntrospector, D1SqliteDialect } = await __turbopack_context__.A("[project]/node_modules/@better-auth/kysely-adapter/dist/d1-sqlite-dialect-D4qp4-wW.mjs [app-rsc] (ecmascript, async loader)");
...
*/ function toPhysicalSchema(db, expected) {
    ...
    for (const [table, definition] of Object.entries(expected)){
        ...
        const sent = sentIdentifiers(db, table, [
...
*/ function sentIdentifiers(db, table, columns) {
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$select$2d$query$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["SelectQueryNode"].is(query)) return {
        table,
        columns: []
    };
    const from = query.from?.froms[0];
    const sentTable = from && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$table$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["TableNode"].is(from) ? from.table : void 0;
    return {
        schema: sentTable?.schema?.name,
        table: sentTable?.identifier.name ?? table,
        columns: (query.selections ?? []).map(({ selection })=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$reference$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ReferenceNode"].is(selection) && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$operation$2d$node$2f$column$2d$node$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ColumnNode"].is(selection.column) ? selection.column.column.name : void 0)
    };
}
/**
...
*/ async function getPostgresSchema(db) {
    return (await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sql"]`
...
async function schemaSearchPath(db, dbType) {
    if (dbType === "postgres") return (await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$kysely$2f$dist$2f$raw$2d$builder$2f$sql$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sql"]`
...
*/ async function findSchemaProblems(db, dbType, expected) {
    ...
    return db.connection().execute(async (connection)=>{
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$diff$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diffSchema"])(physical, tables);
    });
}
//#endregion
...
const kyselyAdapter = (db, config)=>{
    ...
    return (options)=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checksSchema"])(options)) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerSchemaCheck"])(instance, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createSchemaCheck"])(()=>findSchemaProblems(db, config?.type, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$diff$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getExpectedSchema"])(options, {
                usePlural: config?.usePlural
...
*/ function findPrismaSchemaProblems(dataModel, options, usePlural) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$diff$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["diffSchema"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$diff$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getExpectedSchema"])(options, {
        usePlural
...
const prismaAdapter = (prisma, config)=>{
            ...
            const convertWhereClause = ({ action, model, where })=>{
                ...
                if (action === "delete") {
                    ...
                    if (idCondition) {
                        ...
                        if (remainingWhere.length === 0) return {
            ...
            return {
                ...
                async consumeOne ({ model, where }) {
                    ...
                    const claimFromTransaction = async (tx)=>{
                        const target = await tx[model].findFirst({
                            where: findWhere
                        });
                        if (!target) return null;
                        try {
                            return (await tx[model].deleteMany({
                ...
                async incrementOne ({ model, where, increment, set }) {
                    ...
                    for (const [field, delta] of Object.entries(increment))data[field] = {
                        increment: delta
                    };
                    if (where?.some((w)=>w.field === "id")) {
                        const whereClause = convertWhereClause({
    ...
    return (options)=>{
        ...
        if (dataModel && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checksSchema"])(options)) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerSchemaCheck"])(instance, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$better$2d$auth$2f$core$2f$dist$2f$db$2f$schema$2d$check$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createSchemaCheck"])(async ()=>findPrismaSchemaProblems(dataModel, options, config.usePlural), "prisma"));
        return instance;
    };
};
;
}),
"[project]/node_modules/@better-auth/telemetry/dist/node.mjs [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createCipher(core, opts) {
    ...
    return (key, nonce, data, output, counter = 0)=>{
        ...
        if (hasOutput) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["complexOverlapBytes"])(data, output);
...
class _XorStreamPRG {
    ...
    reseed(seed) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["abytes"])(seed, undefined, 'seed');
...
function hchacha(s, k, i, out) {
    ...
    const s2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isLE"] ? s : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["swap32IfBE"])(s.slice(0, 4));
    const k2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isLE"] ? k : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["swap32IfBE"])(k.slice(0, 8));
    const i2 = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isLE"] ? i : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["swap32IfBE"])(i.slice(0, 4));
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isLE"]) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["clean"])(s2, k2, i2);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$noble$2f$ciphers$2f$utils$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["clean"])(t);
}
...
const getCryptoKey = async (secret)=>{
    ...
    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWebcryptoSubtle"])().importKey("raw", secretBuf, algorithm, false, [
        "sign",
        "verify"
    ]);
};
const verifySignature = async (base64Signature, value, secret)=>{
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWebcryptoSubtle"])().verify(algorithm, secret, signature, new TextEncoder().encode(value));
    } catch  {
        return false;
    }
};
const makeSignature = async (value, secret)=>{
    ...
    const signature = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$node_modules$2f40$better$2d$auth$2f$utils$2f$dist$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getWebcryptoSubtle"])().sign(algorithm.name, key, new TextEncoder().encode(value));
...
async function getBody(request, allowedMediaTypes) {
    ...
    if (jsonContentTypeRegex.test(normalizedContentType)) try {
        ...
        if (e instanceof SyntaxError) throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$better$2d$call$2f$dist$2f$error$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["APIError"](400, {
...
"[project]/node_modules/better-call/node_modules/@better-auth/utils/dist/index.mjs [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__20a4go4._.js.map